...
public enum GUIs {
    ...
    ITEMS(new GUI("Items",54).setItems(0,53 , News.nm.getNewsConfig().getItem("empty_news_slot_item")).setItem(45,News.nm.getItemFactory().manufacture("previous_page_item")).setItem(53,News.nm.getItemFactory().manufacture("next_page_item")).setSlotTags(0,44,"itemslot"));
    private GUI gui;
