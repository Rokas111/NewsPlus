...
public enum Messages {
    ...
    SUCCESSFUL_ADD_GUI_MESSAGE("&a&lSuccessfully added GUI to the GUI config"),
    ...
    NO_NEXT_PAGE_MESSAGE("&c&lError► &4No more pages"),
    NO_PREVIOUS_PAGE_MESSAGE("&c&lError► &4No previous page"),
    ...
    NO_ITEMS_MESSAGE("&c&lError► &4No items to show"),
    NO_BOOKS_MESSAGE("&c&lError► &4No books to show"),
    NOT_A_GUI_SIZE_NUMBER_MESSAGE("&c&lError► &4Please enter a number that is divisible by 9"),
    ...
    WRONG_USAGE_ADD_GUI_MESSAGE("&c&lError► &4Wrong command usage. Please use this format /news addgui <GUIName> <GUISize> <GUITitle>"),
    WRONG_USAGE_GET_ITEM_MESSAGE("&c&lError► &4Wrong command usage. Please use this format /news getitem <ItemName>"),
